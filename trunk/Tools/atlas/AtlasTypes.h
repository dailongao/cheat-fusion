...
static const unsigned int CMD_FILLTO = 34;
static const unsigned int CMD_TEST = 35;

static const unsigned int CommandCount = 36;

static const char* CommandStrings[CommandCount] = {
	"JMP", "JMP", "SMA", "HDR", "STRTYPE",
...
{ P_NUMBER }, { P_NUMBER, P_NUMBER } //FILLTO TEST
};
